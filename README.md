...
- 🛠 Skills and technologies: `Java`, `XML`, `HTML`, `Spring Boot`, `Hibernate`, `Spring Security`, `SQL`, `HQL`, `MySQL`, `PostgreSQL`, `Jira`, `Scrum methodology`, `Git`, `GitHub`, `JUnit`, `Mockito`, `integration testing`, `Postman`.
