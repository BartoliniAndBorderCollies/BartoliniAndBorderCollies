...
- 🛠 Skills and technologies: `Java`, `XML`, `HTML`, `Spring Boot`, `Hibernate`, `Spring Security`, `Jira`, `Scrum methodology`, `Git`, `GitHub`, `SQL`, `HQL`, `MySQL`, `JUnit`, `Mockito`, `integration testing`, `Postman`.
